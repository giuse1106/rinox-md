...
mobile: MethodMobile, 
browser: opcion == '1' ? ['rinox-Bot-Md Dev', 'chrome', 'Developer'] : methodCodeQR ? ['rinox-Bot-Md Dev', 'chrome', 'Developer'] : ['Ubuntu', 'Chrome', 'Developer'],
auth: {
creds: state.creds,
...
unlinkSync(`./rinoxBotSession/${files}`)
})
} 
...
const directories = ['./rinoxBotSession/', './jadibts/']
...
if (opcion == '1' || methodCodeQR) {
  ...
  if (connection == 'open') {
    console.log(chalk.green('\nrinox𝐁𝐨𝐭-𝐌𝐝 𝐜𝐨𝐧𝐧𝐞𝐬𝐬𝐨 ✅️ \n'))
  }
let reason = new Boom(lastDisconnect?.error)?.output?.statusCode;
if (reason == 405) {
await fs.unlinkSync("./rinoxBotSession/" + "creds.json")
